...
public record NetworkConfiguration(LaunchPadConfiguration launchPadConfiguration,
    ...
    public static final StreamCodec<FriendlyByteBuf, NetworkConfiguration> STREAM_CODEC = StreamCodec.composite(
    ...
    public static final Codec<NetworkConfiguration> CODEC = RecordCodecBuilder.create(instance ->
        instance.group(
    ...
    public static final Codec<Map<UUID, NetworkConfiguration>> MAP_CODEC =
        Codec.unboundedMap(Codec.STRING.xmap(UUID::fromString, UUID::toString), NetworkConfiguration.CODEC);
}
