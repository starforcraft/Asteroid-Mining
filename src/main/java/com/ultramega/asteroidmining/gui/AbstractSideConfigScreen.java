...
public abstract class AbstractSideConfigScreen<M extends AbstractSideConfigContainerMenu<?>> extends AbstractContainerScreen<M> {
    ...
    public void extractContents(final GuiGraphicsExtractor graphics, final int mouseX, final int mouseY, final float partialTicks) {
        ...
        // TODO: also add these movableWidgets to JEIs gui block dings bumps
